...
serve(async (req: Request) => {
  ...
  try {
    ...
    // URL de confirmation - utilise l'URL du projet Lovable
    const confirmationUrl = `https://gohcvgpwuzlepfcucvmj.supabase.co/confirm-reservation?token=${confirmation_token}`;
